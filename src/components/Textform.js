    ...
    return (
       <>
        <div className='container'>
            ...
            <button className={`btn btn-${props.mode==='success'?'success':'primary'} btn-sm mx-2`} onClick={toUppercae} >Convert To Uppercase</button>
            <button className={`btn btn-${props.mode==='success'?'success':'primary'} btn-sm mx-2`} onClick={toLowercase} >Convert To Uppercase</button>
            <button className={`btn btn-${props.mode==='success'?'success':'primary'} btn-sm mx-2`} onClick={clearText} >Clear Text</button>
        </div>
